...
if __name__ == '__main__':
    ...
    with open("D:\\from_old_pc_2021\\courses_2020\\lesson_3\\test-app-py-cos-db2\\secret\\credentials_cos.json", "r") as read_file:
        data_cos = json.load(read_file)

# Constants for IBM COS values
COS_ENDPOINT = "https://s3.eu-de.cloud-object-storage.appdomain.cloud"
BUCKET_NAME = '33testcos2021'

COS_API_KEY_ID = data_cos['apikey']
COS_INSTANCE_CRN = data_cos['resource_instance_id']
...
if __name__ == '__main__':
    ...
    with open("D:\\from_old_pc_2021\\courses_2020\\lesson_3\\test-app-py-cos-db2\\secret\\credentials_db.json", "r") as read_file:
